...
Usage:
    from tools.implementations.skills_guard import scan_skill, should_allow_install, format_scan_report
...
def llm_audit_skill(skill_path: Path, static_result: ScanResult, model: str = None) -> ScanResult:
    """
    ...
    return ScanResult(
        ...
        summary=_build_summary(
            static_result.skill_name,
            static_result.source,
            static_result.trust_level,
            merged_verdict,
            merged_findings,
        ),
    )
