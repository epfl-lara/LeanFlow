...
# re-exported so callers/tests that resolve tools.mcp_tool.<name> keep working.
# mcp_transport does NOT import mcp_tool, so this introduces no import cycle.
# ---------------------------------------------------------------------------
from tools.mcp_transport import (  # noqa: E402
    _CREDENTIAL_PATTERN,
...
# tools.mcp_tool.<name> keep working.  mcp_sampling does NOT import mcp_tool, so
# this introduces no import cycle.  MCPServerTask.run() (below) instantiates
# SamplingHandler via this re-export.
# ---------------------------------------------------------------------------
from tools.mcp_sampling import (  # noqa: E402
    SamplingHandler,
