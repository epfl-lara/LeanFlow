...
REPO_ROOT = Path(__file__).resolve().parent.parent.parent  # epflemma_cli/native/X.py -> repo root
...
from epflemma_cli.runtime.file_locks import list_file_locks, release_all_file_locks
from epflemma_cli.runtime.skill_core import load_skill
from epflemma_cli.workflows.queue_item_predicates import (  # noqa: E402,F401
...
from epflemma_cli.lean.lean_module_paths import (  # noqa: E402
...
from epflemma_cli.native.native_lean_files import (  # noqa: E402,F401
...
from epflemma_cli.native.native_state import (  # noqa: E402
...
from epflemma_cli.native.native_utils import (  # noqa: E402
...
from epflemma_cli.workflows.verification_review import (  # noqa: E402
    ...
    *,
    ...
    payload = {
        ...
        "formalization_selected_source_document": _read_text_env(
            "EPFLEMMA_FORMALIZATION_SELECTED_SOURCE", ""
        ),
        ...
        "formalization_extracted_blueprint_path": _read_text_env(
            "EPFLEMMA_FORMALIZATION_BLUEPRINT", ""
        ),
...
def _prove_file_scope_ordered_paths(
    ...
    raw = (_read_text_env("EPFLEMMA_PROVE_FILE_SCOPE", "")).strip()
    if not raw:
        return []
...
def _queue_invariant_checks_enabled() -> bool:
    return _read_text_env("EPFLEMMA_QUEUE_INVARIANT_CHECKS", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
...
def _record_formalization_manual_prove_handoff(
    ...
    suggested_command = (
        f"epflemma workflow prove {target}".strip() if target else "epflemma workflow prove"
    )
