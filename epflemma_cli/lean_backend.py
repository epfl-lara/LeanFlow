...
backend primitives that live in :mod:`epflemma_cli.lean_services` — the managed
...
epflemma_cli.lean_services``) rather than importing them at module load. That keeps
