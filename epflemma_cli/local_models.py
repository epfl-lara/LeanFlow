"""Managed local-model runtime helpers for EPFLemma."""
...
def _state_root() -> Path:
    from epflemma_cli.config import ensure_epflemma_home, get_epflemma_home

    ensure_epflemma_home()
    root = get_epflemma_home() / "local-models"
