"""Document text-extraction helpers for EPFLemma formalization preflight.

Split verbatim out of :mod:`epflemma_cli.formalization.formalization_documents`. This is the
