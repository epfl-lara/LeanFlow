...
COMMANDS_BY_CATEGORY = {
    ...
    "Workflow": {
        ...
        "/autoprove": "Compatibility alias for /prove",
        "/autoformalize": "Compatibility alias for /formalize",
    },
    "Runtime": {
        "/status": "Show the current project, provider, model, and runtime summary",
        "/swarm": "List workflow agents or inspect one agent's recent activity",
