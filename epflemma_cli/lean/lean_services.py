...
from epflemma_cli.lean.lean_backend import LeanBackend  # noqa: E402
...
from epflemma_cli.lean.lean_proof_context_local import (  # noqa: E402
...
# import cycle.
from epflemma_cli.lean.lean_sorry_stats import (  # noqa: E402
    _count_sorries,
...
from epflemma_cli.workflows.workflow_state import append_workflow_outcome, workflow_outcomes_path
...
def _repo_root() -> Path:
    return Path(__file__).resolve().parent.parent.parent  # epflemma_cli/lean/X.py -> repo root
...
def probe_capabilities(cwd: str | os.PathLike[str] | None = None) -> LeanCapabilityReport:
    ...
    try:
        from epflemma_cli.cli.mcp_bootstrap import REMOTE_SEARCH_POLICY, managed_mcp_power_status
