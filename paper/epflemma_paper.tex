...
\method also introduces LeanProbe\footnote{\url{https://github.com/Lemmy00/LeanProbe}}, a cached same-file verifier built on LeanInteract~\citep{leaninteract2025}, for repeated proof-repair checks.
...
For each source theorem or lemma, it spells out the parts of the formal type that are most prone to drift: object classes, quantifier order, parameter domains, codomains, hypotheses, side conditions, and follow-on equivalences.
...
It is a standalone CLI, Python library, and MCP server built on LeanInteract~\citep{leaninteract2025}, and is openly available at \href{https://github.com/Lemmy00/LeanProbe}{\texttt{Lemmy00/LeanProbe}}.
...
The \method implementation is available at \href{https://github.com/epfl-lara/EPFLemma}{\texttt{epfl-lara/EPFLemma}}, the LeanProbe verifier at \href{https://github.com/Lemmy00/LeanProbe}{\texttt{Lemmy00/LeanProbe}}, and the generated formalization projects at \href{https://github.com/epfl-lara/AutoformalizedProjects}{\texttt{epfl-lara/AutoformalizedProjects}}.
