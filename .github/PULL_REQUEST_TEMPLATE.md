...
- [ ] I've read the [Contributing Guide](https://github.com/epfl-lara/EPFLemma/blob/main/CONTRIBUTING.md)
- [ ] My commit messages follow [Conventional Commits](https://www.conventionalcommits.org/) (`fix(scope):`, `feat(scope):`, etc.)
- [ ] I searched for [existing PRs](https://github.com/epfl-lara/EPFLemma/pulls) to make sure this isn't a duplicate
...
- [ ] I've considered cross-platform impact (Windows, macOS) per the [compatibility guide](https://github.com/epfl-lara/EPFLemma/blob/main/CONTRIBUTING.md#cross-platform-compatibility) — or N/A
