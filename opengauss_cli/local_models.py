"""Managed local-model runtime helpers for OpenGauss."""
...
from opengauss_cli.config import load_config, save_config
...
def _state_root() -> Path:
    from opengauss_cli.config import ensure_opengauss_home, get_opengauss_home

    ensure_opengauss_home()
    root = get_opengauss_home() / "local-models"
